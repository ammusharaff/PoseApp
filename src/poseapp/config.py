...
MOVENET_LIGHTNING_PATH = resource_path("models/movenet_singlepose_lightning.tflite")
MOVENET_THUNDER_PATH   = resource_path("models/movenet_singlepose_thunder.tflite")
